...
export default function SummerCollectionPage() {
  ...
  useEffect(() => {
    const loadProducts = async () => {
      setIsLoading(true);
      try {
        const data = await getProductsByCollection('summer');
        setProducts(data);
      } catch (error) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Summer Collection</h1>
        <p className="text-lg text-gray-600">
          Discover our refreshing summer fragrances - perfect for warm days and balmy evenings. 
          Light, fresh, and invigorating scents to complement your summer adventures.
        </p>
      </div>
